...
- _(release)_ add support for sparse registry URLs ([#863](https://github.com/MarcoIeni/release-plz/pull/863))
...
- _(workspaces)_ report correct version update ([#802](https://github.com/MarcoIeni/release-plz/pull/802))
...
- _(release)_ add GitLab support (#591).
...
- _(release)_ add the possibility to add `--no-verify` and `--allow-dirty` as cargo publish flags (#532)
...
- _(release)_ trust github workspace dir (#512)
...
- _(release-pr)_ do not include the crate name if there is only one
...
- _(deps)_ bump assert_cmd from 2.0.7 to 2.0.8 (#453)
...
- _(release)_ git-token is optional (#413)
...
- _(deps)_ bump assert_cmd from 2.0.6 to 2.0.7 (#366)
- _(completions)_ add tests for shell completions (#330) (#349)
...
- _(args)_ use the correct case for conflicting arguments (#328)
...
- _(deps)_ bump clap_complete from 3.2.2 to 3.2.3 (#201)
- _(deps)_ bump clap from 3.2.6 to 3.2.8 (#200)
- _(deps)_ bump tracing-subscriber from 0.3.11 to 0.3.14 (#199)
...
- _(deps)_ bump clap and fake libraries (#186)
- _(deps)_ bump tracing from 0.1.34 to 0.1.35 (#179)
- _(deps)_ bump tokio from 1.19.1 to 1.19.2 (#178)
- _(deps)_ bump tokio from 1.18.2 to 1.19.1 (#175)
- _(deps)_ bump git-url-parse from 0.4.1 to 0.4.2 (#172)
...
- _(cli)_ forbid empty values in args (#88)

### Other

- _(args)_ refactor (#87)

## [0.2.3](https://github.com/MarcoIeni/release-plz/compare/release-plz-v0.2.2...release-plz-v0.2.3) - 2022-04-23

### Added

- _(release-pr)_ close old release-plz prs when running release-plz (#81)
